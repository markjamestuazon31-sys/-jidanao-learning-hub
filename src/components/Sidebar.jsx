...
const MENUS = {
  ...
  teacher: {
    ...
    items: [
      ...
      { name: "Create Lessons", path: "/teacher/content-studio", icon: Bot, group: "TEACH" },
      { name: "Create Camera Learning", path: "/teacher/camera-content", icon: Camera, group: "TEACH" },
      { name: "Teacher Learning Zone", path: "/teacher/game-zone", icon: MonitorPlay, group: "TEACH" },
      { name: "Students Directory", path: "/teacher/students", icon: Users, group: "MANAGE CLASS" },
      { name: "Take Attendance", path: "/teacher/attendance", icon: CalendarCheck2, group: "MANAGE CLASS" },
      { name: "Create Quizzes", path: "/teacher/quizzes", icon: ListChecks, group: "ASSESS" },
      { name: "Release Grades", path: "/teacher/grades", icon: ClipboardCheck, group: "ASSESS" },
      { name: "Generate Reports", path: "/teacher/reports", icon: FileBarChart, group: "ASSESS" },
    ],
  },
  admin: {
    ...
    items: [
      ...
      { name: "Teachers & Placement", path: "/admin/teachers", icon: GraduationCap, group: "PEOPLE" },
